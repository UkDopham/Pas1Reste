...
namespace Roberta.Models
{
    ...
    {
        public static List<Recipe> histoRecipes = new List<Recipe>();
        public static List<Recipe> allRecipes = new List<Recipe>();
        public static List<Recipe> favoriRecipes = new List<Recipe>();
        public static List<Product> products = Product.GetAllProducts(histoRecipes);
        ...
        public static void PeuplementRecettes(){
            ...
            gateauChocolat.AddProduct("chocolate","beurre","farine","oeuf","sucre");

            Recipe hamburger = new Recipe("Hamburger","Inspirer des grands cuistots americains", new DateTime(2020,4,13),@"_hamburger.png",2);
            ...
            ramen.AddProduct("pate","poisson","soja");


            favoriRecipes.AddRange(new List<Recipe> { chocolat, gateauAuFour, hamburger, macarons, pizzaMargarita });
            allRecipes.AddRange(new List<Recipe> { tartelleteFruits, biscote, cafeGourmant, chocolat, gateauCitron, gateauChocolat, hamburger, macarons, pizzaMargarita, gateauAuFour, ramen }); 
            histoRecipes.AddRange(new List<Recipe> { tartelleteFruits, biscote, cafeGourmant, chocolat, gateauCitron, gateauChocolat, hamburger, macarons, pizzaMargarita, gateauAuFour, ramen });
        }
